...
É COMO SE FOSSE O "FUNCIONARIO" QUE SABE ACESSAR A TABELA (Pedido.java)
Função:
- Fornecer operações de persistência para a entidade Pedido
- Permitir operações CRUD automaticamente (create, read, update, delete)
*/


import com.exemplo.pedido.entity.Pedido;  /* Ele importa Pedido porque ele precisa saber qual entidade ele gerencia */
